...
80106224:	83 ec 18             	sub    $0x18,%esp
  cprintf("hello world\n");
80106227:	c7 04 24 ef 86 10 80 	movl   $0x801086ef,(%esp)
8010622e:	e8 95 a1 ff ff       	call   801003c8 <cprintf>
  return 1;
80106233:	b8 01 00 00 00       	mov    $0x1,%eax
}
80106238:	c9                   	leave  
80106239:	c3                   	ret    
...
80106567:	c7 44 24 04 fc 86 10 	movl   $0x801086fc,0x4(%esp)
8010656e:	80 
...
801065fb:	8b 04 85 a4 87 10 80 	mov    -0x7fef785c(,%eax,4),%eax
...
80106696:	c7 04 24 04 87 10 80 	movl   $0x80108704,(%esp)
...
801066ee:	c7 04 24 28 87 10 80 	movl   $0x80108728,(%esp)
801066f5:	e8 ce 9c ff ff       	call   801003c8 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801066fa:	c7 04 24 5a 87 10 80 	movl   $0x8010875a,(%esp)
...
80106764:	c7 04 24 60 87 10 80 	movl   $0x80108760,(%esp)
...
80106915:	e8 25 c1 ff ff       	call   80102a3f <ioapicenable>
  ...
  for(p="xv6...\n"; *p; p++)
8010691a:	c7 45 f4 24 88 10 80 	movl   $0x80108824,-0xc(%ebp)
...
80107901:	74 0c                	je     8010790f <mappages+0x66>
      panic("remap");
80107903:	c7 04 24 2c 88 10 80 	movl   $0x8010882c,(%esp)
...
80107a2a:	c7 04 24 32 88 10 80 	movl   $0x80108832,(%esp)
...
80107a40:	c7 04 24 48 88 10 80 	movl   $0x80108848,(%esp)
...
80107a56:	c7 04 24 5d 88 10 80 	movl   $0x8010885d,(%esp)
...
80107bbb:	c7 04 24 71 88 10 80 	movl   $0x80108871,(%esp)
...
80107c46:	c7 04 24 8c 88 10 80 	movl   $0x8010888c,(%esp)
...
80107c86:	c7 04 24 af 88 10 80 	movl   $0x801088af,(%esp)
...
80107d61:	c7 04 24 cd 88 10 80 	movl   $0x801088cd,(%esp)
...
80107dde:	c7 04 24 e5 88 10 80 	movl   $0x801088e5,(%esp)
...
80107eae:	75 0c                	jne    80107ebc <deallocuvm+0x8f>
        panic("kfree");
80107eb0:	c7 04 24 01 89 10 80 	movl   $0x80108901,(%esp)
...
80107eff:	c7 04 24 07 89 10 80 	movl   $0x80108907,(%esp)
...
80107fb1:	75 0c                	jne    80107fbf <clearpteu+0x35>
    panic("clearpteu");
80107fb3:	c7 04 24 18 89 10 80 	movl   $0x80108918,(%esp)
...
8010801d:	c7 04 24 22 89 10 80 	movl   $0x80108922,(%esp)
...
80108035:	c7 04 24 3c 89 10 80 	movl   $0x8010893c,(%esp)
